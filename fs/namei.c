...
out:
	...
	if(error>=0)
	{
		mylogger4("mknodat", dfd, filename);
	}
	return error;
}
...
{
	int temp = sys_mknodat(AT_FDCWD, filename, mode, dev);
	if(temp>=0)
	{
		mylogger1("mknod", filename);
	}
	return temp;
}
...
retry:
	...
	if(error>=0)
	{
		mylogger4("mkdirat", dfd, pathname);
	}
	return error;
}
...
{
	int temp = sys_mkdirat(AT_FDCWD, pathname, mode);
	if(temp>=0)
	{
		mylogger1("mkdir", pathname);
	}
	return temp;
}
...
{
	int temp= do_rmdir(AT_FDCWD, pathname);
	if(temp>=0)
	{
		mylogger1("rmdir", pathname);
	}
	return temp;
}
...
exit1:
	...
	if(error>=0)
	{
		mylogger4("unlinkat", dfd, pathname);
	}
	return error;
...
{
	int temp= do_unlinkat(AT_FDCWD, pathname);
	if(temp >=0)
	{
		mylogger1("unlink", pathname);
	}
	return temp;
}
...
exit:
	if(error>=0)
	{
		mylogger4("renameat2", newdfd, newname);
	}
	return error;
}
...
SYSCALL_DEFINE4(renameat, int, olddfd, const char __user *, oldname,
		int, newdfd, const char __user *, newname)
{
	int temp=sys_renameat2(olddfd, oldname, newdfd, newname, 0);
	if(temp>=0)
	{
		mylogger4("renameat", newdfd, newname);
	}
	return temp;
}
...
SYSCALL_DEFINE2(rename, const char __user *, oldname, const char __user *, newname)
{
	...
	int temp= sys_renameat2(AT_FDCWD, oldname, AT_FDCWD, newname, 0);
	if(temp>=0)
	{
		mylogger1("rename", newname);
	}
	return temp;
}
